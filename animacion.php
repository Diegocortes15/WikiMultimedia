...
?>
        ...
        <div class="hero_animacion">
            <h2 class="titulo_banner barra_banner centrar_contenido fw_400">Animación</h2>
        </div>
    </header>
    <div class="background_blanco_pagina contenedor">
        ...
        <?php
                    ...
                    $sql = "SELECT * FROM `articulos` WHERE `categoria_articulo` = 'animacion' ORDER BY `articulos`.`id_articulo` DESC";
