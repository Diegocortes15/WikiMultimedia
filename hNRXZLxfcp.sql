...
--
-- Servidor: localhost
-- Tiempo de generación: 28-04-2020 a las 23:34:46
...
CREATE TABLE `registros` (
  ...
  `contrasenia_usuario` varchar(65) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
...
--
ALTER TABLE `articulos`
  ADD CONSTRAINT `articulos_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `registros` (`id_usuario`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
