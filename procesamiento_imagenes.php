...
?>
        ...
        <div class="hero_imagenes">
            <h2 class="titulo_banner barra_banner centrar_contenido fw_400">Procesamiento de Imagenes</h2>
        </div>
    </header>
    <div class="background_blanco_pagina contenedor">
        ...
        <?php
                    ...
                    $sql = "SELECT * FROM `articulos` WHERE `categoria_articulo` = 'procesamiento_imagenes' ORDER BY `articulos`.`id_articulo` DESC";
