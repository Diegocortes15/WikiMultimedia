...
?>
        ...
        <div class="hero_lenguajes_de_programacion">
            <h2 class="titulo_banner barra_banner centrar_contenido fw_400">Lenguajes de Programación</h2>
        </div>
    </header>
    <div class="background_blanco_pagina contenedor">
        ...
        <?php
                    ...
                    $sql = "SELECT * FROM `articulos` WHERE `categoria_articulo` = 'lenguajes_de_programacion' ORDER BY `articulos`.`id_articulo` DESC";
